...
<div class="top-bar">
	...
	<div class="drop-item sd-active sfont" onclick="setPage(13)" id="item11" >view result</div>
                                        ...
                                        ?>
                                         ...
                                         <div class="container p-4 m-5 col-sm-3 border border-dark">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <a href="admin/upload/<?php echo $row['fname'] ?>" class="btn btn-primary" target="_blank">Read result</a>
                                            </div>
                                        </div>
