    ...
    <div class="modal-content">
      ...
      <div class="modal-body px-5">
		...
		<div class="mb-3">
			...
			<input id="batch" type="text" placeholder="2019 2020 2021 2022" class="form-control">
		</div>
		<div class="mb-3">
...
function addStudent() {
  ...
  xhttp.send("nic="+nic.value+"&fn="+fn.value+"&ln="+ln.value+"&email="+email.value+"&dep="+dep.value+"&phone="+phone.value+"&batch="+batch.value+"&pos=1");
}
...
function retStCards(){
	...
	if(keyword.value == "" || keyword.value == " "){
		...
		xhttp.send("kword="+keyword.value+"&pos=1");
	}
	...
	function saveChanges(stid){
		...
		batche=document.getElementById("batche");
		  ...
		  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		  xhttp.send("nic="+nice.value+"&fn="+fne.value+"&ln="+lne.value+"&email="+emaile.value+"&dep="+depe.value+"&phone="+phonee.value+"&batch="+batche.value+"&stid="+stid+"&pos=1");
