...
<div class="offcanvas-md offcanvas-start d-flex flex-column flex-shrink-0 p-3 text-light bg-dark h-100 " tabindex="-1" id="offcanvas" aria-labelledby="offcanvasLabel" style="width: 280px;" id="sidePanel">
    ...
    <a  class="d-flex align-items-center mb-3 mb-md-0 text-white text-decoration-none">
      ...
      <!--span class="fs-4 flex-fill">USHD</span-->
	  <button type="button" class="bg-dark border border-0 text-white fs-4 pe-2 d-sm-block d-md-none" data-bs-dismiss="offcanvas" aria-label="Close" data-bs-target="#offcanvas">&times;</button>
    </a>
    <hr>
    <ul class="nav nav-pills flex-column mb-auto">
      ...
      <li class='mt-1'>
        <a href="teacher.php" class="nav-link text-white d-flex align-items-center" id="teacher">
          <i class="fa-solid fa-user me-3 fs-5"></i>
          <span>Teacher</span>
        </a>
      </li class='mt-1'>
      <li class='mt-1'>
        <a href="student.php" class="nav-link text-white d-flex align-items-center" id="student">
          <i class="fa-solid fa-user me-3 fs-5"></i>
          </span>Student</span>
        </a>
      </li>
	  ...
	  <li class='mt-1'>
        <a href="activitylog.php" class="nav-link text-white d-flex align-items-center" id="actlog">
          <i class="fa-solid fa-file-pen me-3 fs-5"></i>
          </span>Activity log</span>
        </a>
      </li>
	  <li class='mt-1'>
        <a href="userlog.php" class="nav-link text-white d-flex align-items-center" id="usrlog">
          <i class="fa-solid fa-address-book me-3 fs-5"></i>
          </span>User log</span>
        </a>
      </li>
    </ul>
 ...
 <div class="dropdown ms-auto d-flex align-items-center">
  ...
  <div class="bg-dark p-2 text-light dropdown-toggle ms-auto" type="button" data-bs-toggle="dropdown" aria-expanded="false">
    <?php echo $row['afirstname']." ".$row['alastname']?>
  </div>
