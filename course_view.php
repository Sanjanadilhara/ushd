...
<body>
	...
	<div class="drop-item sd-active sfont" onclick="setPage(6)" id="item7" >view courses</div>
                    ...
                    <div class="col">
                        <div class="row">
                            <div class="col text-white" id="adclr">
                                ...
                                <h3 class="text-center">Viwe courses</h3>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="container mt-4 ">
                                <div class="row">
                                    ...
                                    <?php
                                    if (empty($result)) {
                                        ?> <h3> Plese select data you need </h3><?php
                                    } else {
                                    ...
                                    ?>
                                                <!--cousers show-->
                                                <div class="container p-4 m-5 col-md-3 border border-dark">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <a href="viwe_lc_material.php?id=<?= $row["cid"]; ?>" class="btn btn-primary">Show content</a>
                                                    </div>
                                                </div>
